...
<html lang="en">
  <head>
    @include('cmsgroovel.includes.groovel_admin_permissions_users_head')
  </head>
	 	...
	 	<div class="row">   
		    @if(Session::get('user_privileges')!=null)
		        	@if(Session::get('user_privileges')['role']=='ADMIN')
		      	    ...
		      	    @endif
				@endif
		         <div class="col-sm-8 col-sm-offset-1 col-xs-12 col-md-9 col-md-offset-0 col-lg-9 col-lg-offset-2">
		 			   @yield('content')
		        </div>
		  </div>
  </div>
