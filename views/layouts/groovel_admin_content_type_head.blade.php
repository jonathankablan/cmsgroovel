<meta charset="utf-8">
    ...
    {!! HTML::script('packages/groovel/cmsgroovel/groovel/admin/js/groovel_content_types.js') !!}
    ...
    {!! HTML::script('packages/groovel/cmsgroovel/jquery/js/jquery-ui.js') !!}
	{!!HTML::style('packages/groovel/cmsgroovel/jquery/css/jquery-ui.css')!!}
