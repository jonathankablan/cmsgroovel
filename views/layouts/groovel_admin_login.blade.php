	 ...
	 <footer>  
     	<div class="row-fluid">
     		<div class="col-md-10 col-md-offset-3">
	        	{!! HTML::image('groovel/cmsgroovel/groovel/admin/images/groovel.png', $alt="groovel", $attributes = array('style'=>'width:100px;height:50px')) !!} Maintained by the <a href="http://www.groovelcms.com/">groovel</a> 
