...
<html lang="en">
  ...
  <body>
		   ...
		   <div class="panel-heading">
			...
			<div class="row" style='margin-top:25px'>
			 ...
			 <!--  <div class="row">
				...
				<input type="submit" id="admin_config_form_location" value="Save Configuration"  class="btn btn-default" style="margin-left:450px;margin-bottom:20px"/>
				{!! Form::close() !!}	
			</div>
		</div>
		<div class="panel panel-primary" >
	...
	<!-- <div class="col-md-5"  style='margin-top:50px'>
		 <div class="panel panel-primary">
		   <div class="panel-heading">
		        <h3 class="panel-title"><i class="fa fa-clock-o"></i><font color='black'>Search engine</font></h3>
		   </div>
			<div class="row" style='margin-top:25px'>
			...
			<?php   $states=['0'=>'Disabled','1'=>'Enabled'];
			 ...
			 ?>			 	  
				...
				<input type="submit" id="admin_config_search_form" value="Save Configuration"  class="btn btn-default" style="margin-left:350px;margin-top:50px;margin-bottom:25px"/>
				{!! Form::close() !!}
			</div>
		</div>-->
	<div class="panel panel-primary">
		  ...
		  {!! Form::open(array('id'=>'admin_config_maintenance_form','url' => 'admin/configuration/maintenance', 'method' => 'POST')) !!}
			 ...
			 ?>							      
		      <div class="panel-body">
				...
				<input type="submit" id="admin_config_maintenance_form" value="Save Configuration"  class="btn btn-default" style="margin-left:330px;margin-top:50px;margin-bottom:25px"/>
				{!! Form::close() !!}
			</div>
		</div>
	</div>
			...
			<?php   $states=['0'=>'Disabled','1'=>'Enabled'];
			 ...
			 ?>							      
		      <div class="panel-body">
				...
				<input type="submit" id="admin_config_email_form" value="Save Configuration"  class="btn btn-default" style="margin-left:330px;margin-top:50px;margin-bottom:25px"/>
				{!! Form::close() !!}
			</div>
		</div>
