<meta charset="utf-8">
  ...
  <!-- <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js"></script>
   ...
   <link href="./public/theme-admin/css/dashboard.css" rel="stylesheet">-->
    ...
    {!! HTML::script('packages/groovel/cmsgroovel/cdnjs-cloudfare/d3/js/d3.min.js') !!}
    {!! HTML::script('packages/groovel/cmsgroovel/cdnjs-cloudfare/topojson/js/topojson.min.js') !!}
    {!! HTML::script('packages/groovel/cmsgroovel/datamaps/js/datamaps.world.min.js') !!}
    
    {!! HTML::script('packages/groovel/cmsgroovel/jqplot/js/jquery.jqplot.min.js')!!}
