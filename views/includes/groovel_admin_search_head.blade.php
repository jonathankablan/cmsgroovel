<meta charset="utf-8">
    ...
    {!! HTML::script('groovel/cmsgroovel/cdnjs-cloudfare/d3/js/d3.min.js') !!}
    {!! HTML::script('groovel/cmsgroovel/cdnjs-cloudfare/topojson/js/topojson.min.js') !!}
    {!! HTML::script('groovel/cmsgroovel/datamaps/js/datamaps.world.min.js') !!}
    
    {!! HTML::script('groovel/cmsgroovel/jqplot/js/jquery.jqplot.min.js')!!}
    {!!HTML::style('groovel/cmsgroovel/jqplot/css/jquery.jqplot.css')!!}
     {!! HTML::script('groovel/cmsgroovel/jqplot/js/plugins/jqplot.dateAxisRenderer.min.js')!!}
