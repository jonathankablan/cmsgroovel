<meta charset="utf-8">
    ...
    <link href="/groovel/cmsgroovel/jqplot/css/jquery.jqplot.css" rel="stylesheet">
    ...
    <script src="/groovel/cmsgroovel/cdnjs-cloudfare/d3/js/d3.min.js"></script> 
    <script src="/groovel/cmsgroovel/cdnjs-cloudfare/topojson/js/topojson.min.js"></script> 
    <script src="/groovel/cmsgroovel/datamaps/js/datamaps.world.min.js"></script> 
    <script src="/groovel/cmsgroovel/jqplot/js/jquery.jqplot.min.js"></script>   
    <script src="/groovel/cmsgroovel/jqplot/js/plugins/jqplot.dateAxisRenderer.min.js"></script> 
