...
use controllers\groovel\admin\users_rules\GroovelUserRulesController;
...
class GroovelFilterController extends GroovelController {
   ...
   public function filter(){
  	 try{
 	      ...
 	      $rulesController = $app->make('controllers\groovel\admin\users_rules\GroovelUserRulesController');
	      $route= $controller->getRouteFromSession();
	      //\Log::info($route);
	      $userTrackingController = $app->make('controllers\groovel\admin\users_tracking\GroovelTrackingUserAPI');
	      $configController = $app->make('controllers\groovel\admin\configuration\GroovelSystemConfigurationController');
