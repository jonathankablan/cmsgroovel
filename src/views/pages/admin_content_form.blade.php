						...
						<div id='fade'></div>
					     <div id='form-modal' class="modal-body">
							<div class="panel-body">
							   ...
							   <p style="margin-left: 350px;">Title And Url</p>
							   </div>
				            	...
				            	<div class="form-group form-inline">
				                	{{ Form::label('groovelDescription', 'groovelDescription', array('class' => 'col-md-3 control-label required')).Form::text('groovelDescription', Session::get('content_edit')['groovelDescription'], $attributes = array('class' => 'form-control','style'=>'width:450px')) }}
				            	</div>
							   ...
							   <p style="margin-left: 350px;">Content</p>
						        ...
						        <br/>
						      <div style="margin-top: 30px; margin-bottom: 15px;width: 100%; height: 60px; background-color: rgb(152, 251, 152)">
							   <p style="margin-left: 350px;">Section Publish or Not</p>
							   </div>
